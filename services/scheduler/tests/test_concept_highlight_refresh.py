...
from aclarai_scheduler.concept_highlight_refresh import ConceptHighlightRefreshJob
...
class TestConceptHighlightRefreshJob:
    ...
    def test_run_job_success(self):
        ...
        with patch("aclarai_scheduler.concept_highlight_refresh.TopConceptsJob") as mock_top_concepts_class:
            with patch("aclarai_scheduler.concept_highlight_refresh.TrendingTopicsJob") as mock_trending_topics_class:
    ...
    def test_run_job_exception_handling(self):
        ...
        with patch("aclarai_scheduler.concept_highlight_refresh.TopConceptsJob") as mock_top_concepts_class:
            with patch("aclarai_scheduler.concept_highlight_refresh.TrendingTopicsJob") as mock_trending_topics_class:
                ...
                mock_top_concepts_job.run_job.side_effect = Exception("Unexpected error")
