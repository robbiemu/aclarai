    ...
    def run_job(self) -> ConceptHighlightRefreshJobStats:
            ...
            if not job_stats["top_concepts_stats"]["success"]:
                self.logger.warning(
                    ...
                    extra={
                        "service": "aclarai-scheduler",
                        "filename.function_name": "concept_highlight_refresh.run_job",
                        "top_concepts_errors": job_stats["top_concepts_stats"][
                            "error_details"
                        ],
                    },
                )
                job_stats["error_details"].extend(
                    [
                        f"Top concepts: {error}"
                        for error in job_stats["top_concepts_stats"]["error_details"]
                    ]
                )
            ...
            if not job_stats["trending_topics_stats"]["success"]:
                self.logger.warning(
                    ...
                    extra={
                        "service": "aclarai-scheduler",
                        "filename.function_name": "concept_highlight_refresh.run_job",
                        "trending_topics_errors": job_stats["trending_topics_stats"][
                            "error_details"
                        ],
                    },
                )
                job_stats["error_details"].extend(
                    [
                        f"Trending topics: {error}"
                        for error in job_stats["trending_topics_stats"]["error_details"]
                    ]
                )

            # Overall success is true if at least one job succeeded
            job_stats["success"] = (
                job_stats["top_concepts_stats"]["success"]
                or job_stats["trending_topics_stats"]["success"]
            )
        ...
        self.logger.info(
            ...
            extra={
                ...
                "trending_topics_success": job_stats["trending_topics_stats"][
                    "success"
                ],
