...
class TestConfigurationPanelIntegration:
    ...
    def test_concept_highlights_inputs_present(self, page: Page, gradio_app):
        ...
        expect(page.locator("text=Percent").nth(0)).to_be_visible()  # Top concepts percent
        expect(page.locator("text=Target File").nth(0)).to_be_visible()  # Top concepts file
        ...
        expect(page.locator("text=Count").nth(1)).to_be_visible()  # Trending topics count
        expect(page.locator("text=Percent").nth(1)).to_be_visible()  # Trending topics percent
        expect(page.locator("text=Target File").nth(1)).to_be_visible()  # Trending topics file
    ...
    def test_trending_concepts_agent_synchronization(self, page: Page, gradio_app):
        ...
        main_trending_agent_input = page.locator("text=Trending Concepts Agent").locator("..//input")
        
        # Find the trending concepts agent input in the Highlight section
        summary_trending_agent_input = page.locator("text=Model for Trending Concepts Agent").locator("..//input")
    ...
    def test_filename_preview_functionality(self, page: Page, gradio_app):
        ...
        trending_file_input = page.locator("text=Target File").nth(1).locator("..//input")
