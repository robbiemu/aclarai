...
from aclarai_shared.config import ThresholdConfig, aclaraiConfig
...
class TestClaimConceptLinkingThresholds:
    ...
    def test_link_claims_supports_concept_above_threshold(self):
        ...
        with (
            patch.object(self.linker, "_find_candidate_concepts_vector") as mock_find,
    ...
    def test_link_claims_null_scores_rejected_all_types(self):
        ...
        for relationship_type in [
            ...
            with (
                patch.object(
                    self.linker, "_find_candidate_concepts_vector"
                ) as mock_find,
                patch.object(self.linker, "_create_claim_concept_pair") as mock_pair,
            ):
                mock_candidate = Mock()
