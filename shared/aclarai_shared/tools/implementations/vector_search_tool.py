...
class VectorSearchTool(AclaraiBaseTool):
    ...
    def metadata(self) -> ToolMetadata:
        ...
        return ToolMetadata(
            ...
            input_parameters={
                ...
                "collections": {
                    "type": "array",
                    "description": "Optional list of specific collections to search"
                },
                "max_results": {
                    "type": "integer",
                    "description": "Optional maximum number of results per collection"
                }
            }
        )
    ...
    def _call(
        ...
        try:
            ...
            invalid_collections = set(search_collections) - set(self._vector_stores.keys())
            if invalid_collections:
                return f"Invalid collections specified: {', '.join(invalid_collections)}"
